...
public class SalesOrderTest extends BaseClass
{
	 ...
	 * 6. verify using popup
	 * @throws Throwable 
	 */
	@Test
	public void deleteSalesOrderTest() throws Throwable
	{
		ExtentTest logger =  extent.startTest("deleteSalesOrderTest");
		String deletedrecord=elib.getExcelData("salesorder", 7, 2);
		...
		SalesOrder spage=PageFactory.initElements(driver, SalesOrder.class);
		spage.selectrecordfordelete();;
		
		/*sstep 4 : navigate to sales order info page and go for delete*/
		logger.log(LogStatus.INFO, " navigate to sales order info page and go for edit");
		
		SalesOrderInfoPage sinfopage=PageFactory.initElements(driver, SalesOrderInfoPage.class);
		sinfopage.deleterecord();
		/*STEP 6 : verify whether record is deleted*/
		
		logger.log(LogStatus.INFO, "verify whether record is deleted");
		SalesOrder sdpage=PageFactory.initElements(driver, SalesOrder.class);
		sdpage.verifyrecorddeleted(deletedrecord);
